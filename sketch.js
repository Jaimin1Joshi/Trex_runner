...
function setup() {// to add before draw procedures
  ...
  ground = createSprite(20,160,380,30);
  // to add image
  ground.addImage("ground",groundimg);
  
  ground2 = createSprite(20,190,380,30);
 ...
 //creating repeated backgroung
  ...
  cloudgrp=new Group();
  overobj = createSprite(270,110,30,30);
  overobj.addImage("crash",overimg);
  overobj.visible = false;
  restartobj = createSprite(280,70,30,30);
...
function clouds() {
  ...
  cloud = createSprite(500,30,10,10);
    ...
    cloud.x=Math.round(random(500,580));
